        ...
        <div className="bg-white/20 backdrop-blur-2xl border border-white/30 rounded-3xl shadow-2xl p-6 sm:p-8 relative overflow-hidden">
          ...
          <div className="flex bg-white/10 backdrop-blur-sm rounded-xl p-1.5 mb-4 sm:mb-6 border border-white/20">
            <button
              ...
              className={`flex-1 py-2 sm:py-3 px-2 sm:px-4 rounded-lg sm:rounded-xl font-semibold text-xs sm:text-sm transition-all duration-300 transform ${
                role === "customer"
          ...
          <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
            {/* Username Field */}
            <div className="relative">
              <div className={`absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center transition-colors duration-300 ${
                focusedField === 'username' ? 'text-pink-300' : 'text-white/50'
              }`}>
              ...
              <input
                ...
                className={`w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-4 bg-white/10 backdrop-blur-sm border rounded-2xl text-white placeholder-white/50 focus:outline-none transition-all duration-300 text-sm sm:text-base ${
                  focusedField === 'username' 
                    ? 'border-pink-400 bg-white/20 shadow-lg transform scale-[1.02]' 
                    : 'border-white/30 hover:border-white/50'
                }`}
              />
              <div className={`absolute inset-0 rounded-2xl bg-gradient-to-r from-pink-500/20 to-purple-500/20 opacity-0 transition-opacity duration-300 pointer-events-none ${
            ...
            <div className="relative">
              <div className={`absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center transition-colors duration-300 ${
                focusedField === 'password' ? 'text-pink-300' : 'text-white/50'
              }`}>
              ...
              <input
                ...
                onBlur={() => setFocusedField(null)}
                onKeyPress={handleKeyPress}
                className={`w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-3 sm:py-4 bg-white/10 backdrop-blur-sm border rounded-2xl text-white placeholder-white/50 focus:outline-none transition-all duration-300 text-sm sm:text-base ${
          ...
          <button
            onClick={handleLogin}
            disabled={isLoading}
            className={`w-full py-3 sm:py-4 rounded-2xl font-bold text-base sm:text-lg transition-all duration-300 transform relative overflow-hidden group ${
              isLoading 
